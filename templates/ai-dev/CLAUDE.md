...
The workspace includes Codex, Claude Code, Playwright browser tooling, Unity Hub, Blender, Node.js, Foundry, Docker, and GitHub tooling. Unity Editor installations and licenses live in the persistent home volume.
