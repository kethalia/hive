...
This is a **council reviewer workspace** — it runs AI-powered code review using Claude CLI
against PR branches. Claude Code is installed and configured via ANTHROPIC_API_KEY.
