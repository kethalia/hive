...
**M004 in progress — 1 of 3 slices complete.**
...
- S02 (Push Job Worker & SSE Streaming Route): ⬜ remaining
- S03 (Templates Dashboard Page with xterm.js): ⬜ remaining
...
- **Template Management:** Staleness engine compares local template files against Coder's active version via deterministic sha256 hashing of sorted file paths + contents
