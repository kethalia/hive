...
**M010 in progress — 3 of 4 slices complete.** Multi-user Coder authentication replacing static env vars with per-user, per-deployment credentials. 51 new tests in S03, total across project growing.
